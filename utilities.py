"""
This module contain utility functions mostly related to the file processing
"""
...
def deserialize_file (f_corpus):
    ...
    conll = stanza.utils.conll.CoNLL.load_conll(get_text (f_corpus))
    return conll
